  ...
  await page.addInitScript((initialPreferences) => {
    ...
    (window as Window & { RedmineCanvasGantt?: unknown }).RedmineCanvasGantt = {
      ...
      i18n: {
        ...
        label_action_constraint: 'Dependency or date constraint',
        label_action_overdue: 'Overdue',
        label_action_missing_dates: 'Missing start or due date',
        label_action_unassigned: 'No assignee',
        label_action_missing_estimate: 'No estimated hours',
        label_action_other_reasons: 'and %{count} more',
        label_action_filter: 'Filter by reason',
        label_action_planned_overload: 'Planned overload',
        label_action_overload_days: 'assignee-days',
        label_action_open_workload: 'Open workload to calculate',
      },
      settings: {
