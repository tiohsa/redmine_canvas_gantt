module RedmineCanvasGantt
  class IssueSelector
    ...
    def call(query_issue_scope:, project_ids:, redmine_project_ids:, state:, scope_only: false)
    ...
    def issues_scope_for(query_issue_scope:, project_ids:, redmine_project_ids:, state:)
