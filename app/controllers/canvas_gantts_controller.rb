...
class CanvasGanttsController < ApplicationController
  ...
  I18N_LABELS = {
    ...
    label_display_settings_scope: :label_display_settings_scope,
    label_display_settings_visibility: :label_display_settings_visibility,
    label_display_settings_heading: :label_display_settings_heading,
