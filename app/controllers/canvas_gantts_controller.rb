...
class CanvasGanttsController < ApplicationController
  ...
  I18N_LABELS = {
    ...
    button_save_issue: :button_save_issue,
    button_create_issue: :button_create_issue,
    button_save_comment: :button_save_comment,
    button_edit_issue: :button_edit_issue,
    button_log_time: :button_log_time,
    ...
    label_saving_comment: :label_saving_comment,
  ...
  help_desc_settings: :help_desc_settings,
    ...
    help_desc_hierarchy_lines: :help_desc_hierarchy_lines,
    ...
    field_timer: :field_timer,
    label_work_timer: :label_work_timer,
    label_timer_start: :label_timer_start,
    label_timer_running: :label_timer_running,
    label_timer_stop: :label_timer_stop,
    label_timer_extend: :label_timer_extend,
    label_timer_auto_stop: :label_timer_auto_stop,
    label_timer_minutes: :label_timer_minutes,
    label_timer_record_time: :label_timer_record_time,
    label_timer_or: :label_timer_or,
    label_timer_manage_pending: :label_timer_manage_pending,
    label_timer_pending_record_desc: :label_timer_pending_record_desc,
    label_timer_pending_resume_section: :label_timer_pending_resume_section,
    label_timer_pending_resume_desc: :label_timer_pending_resume_desc,
    label_timer_discard: :label_timer_discard,
    label_timer_pending_work: :label_timer_pending_work,
    label_timer_discard_confirm: :label_timer_discard_confirm,
    label_timer_elapsed: :label_timer_elapsed,
    label_timer_remaining: :label_timer_remaining,
    label_timer_overrun: :label_timer_overrun,
    label_timer_work_time: :label_timer_work_time,
    label_timer_recording_in_progress: :label_timer_recording_in_progress,
    label_timer_recording_recovery: :label_timer_recording_recovery,
    label_timer_recording_recovery_confirm: :label_timer_recording_recovery_confirm,
    ...
    label_timer_mark_unregistered: :label_timer_mark_unregistered,
    label_timer_validation_error: :label_timer_validation_error,
    label_timer_unknown_error: :label_timer_unknown_error,
    ...
    label_timer_notification_body_stopped: :label_timer_notification_body_stopped,
    label_timer_cross_day_warning: :label_timer_cross_day_warning,
    label_timer_conflict_cancelled: :label_timer_conflict_cancelled,
    label_timer_cannot_log_time: :label_timer_cannot_log_time,
    label_timer_aria_start: :label_timer_aria_start,
    label_timer_aria_running: :label_timer_aria_running,
    label_timer_aria_pending: :label_timer_aria_pending
  }.freeze
