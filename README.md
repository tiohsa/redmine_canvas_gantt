...
- Actual data respects Redmine Issue/Time Entry visibility and the current project/query scope. Requests are limited to the displayed period (up to 3,661 calendar dates) and the configured collection budget; oversized results produce an error rather than partial totals.
